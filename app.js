...
<head>
  ...
  <style>
    ...
    table{border-collapse:collapse;width:100%;}
		...
		ul.task-list li,ol.task-list li,li.task-list-item{display:flex;gap:.55rem;align-items:flex-start;flex-wrap:nowrap;white-space:nowrap;position:relative;padding-bottom:1.8rem;min-width:0;transition:transform 1.8s ease,opacity 1.8s ease;animation:task-fade 1.2s ease both;will-change:transform,opacity;color:var(--accent-text);font-size:1.1rem;font-weight:400;}
		...
		ul.task-list li.task-list-item.checked label,ol.task-list li.task-list-item.checked label,li.task-list-item.checked label{text-decoration:line-through;text-decoration-thickness:1px;text-decoration-color:var(--accent-strong);}
		ul.task-list li.task-list-item.checked label *,ol.task-list li.task-list-item.checked label *,li.task-list-item.checked label *{text-decoration:line-through;text-decoration-thickness:1px;text-decoration-color:var(--accent-strong);}
