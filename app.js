...
<head>
  ...
  <style>
    ...
    table{border-collapse:collapse;width:100%;}
		...
		ul.task-list li,ol.task-list li,li.task-list-item{display:flex;gap:.55rem;align-items:flex-start;flex-wrap:nowrap;white-space:nowrap;position:relative;padding-bottom:1.45rem;min-width:0;transition:transform .28s ease,opacity .28s ease;animation:task-fade .28s ease both;will-change:transform,opacity;color:var(--accent-text);font-size:1.1rem;font-weight:400;}
		...
		ul.task-list li > .task-closed-at,ol.task-list li > .task-closed-at,li.task-list-item > .task-closed-at{position:absolute;left:calc(2.3rem);top:1.45rem;margin-left:0;white-space:nowrap;}
