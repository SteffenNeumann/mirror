...
(function () {
	...
	const THEMES = {
		...
		monoLight: {
			...
			bottom: "rgba(241, 245, 249, 0.6)",
			accentBgSoft: "rgba(241, 245, 249, 0.2)",
			accentBg: "rgba(241, 245, 249, 0.28)",
			accentBgHover: "rgba(241, 245, 249, 0.36)",
			accentBadgeBg: "rgba(241, 245, 249, 0.36)",
			accentStrong: "rgba(226, 232, 240, 0.8)",
			accentStrongHover: "rgba(226, 232, 240, 0.9)",
			accentStrongActive: "rgba(226, 232, 240, 1)",
			accentBorder: "rgba(241, 245, 249, 0.45)",
			accentBorderStrong: "rgba(241, 245, 249, 0.6)",
			accentText: "rgba(255, 255, 255, 0.98)",
			accentTextSoft: "rgba(248, 250, 252, 0.96)",
			accentRing: "rgba(241, 245, 249, 0.35)",
			accentRingStrong: "rgba(241, 245, 249, 0.5)",
		},
		monoDark: {
			label: "Mono Dark",
