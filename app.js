...
<head>
  ...
  <style>
    ...
    table{border-collapse:collapse;width:100%;}
		...
		ul.task-list li,ol.task-list li,li.task-list-item{display:flex;gap:.55rem;align-items:flex-start;flex-wrap:nowrap;white-space:nowrap;position:relative;padding-bottom:1.8rem;min-width:0;transition:transform 2.8s ease,opacity 2.8s ease;animation:task-fade 2.8s ease both;will-change:transform,opacity;color:var(--accent-text);font-size:1.1rem;font-weight:400;}
		...
		ul.task-list li.task-list-item.checked,ol.task-list li.task-list-item.checked,li.task-list-item.checked{opacity:.8;color:var(--accent-text-soft);transform:translateY(18px);animation:task-fade 2.8s ease both,task-move 2.6s ease both;}
		...
		@keyframes task-fade{from{opacity:0;transform:translateY(16px);}to{opacity:1;transform:translateY(0);}}
		@keyframes task-move{from{transform:translateY(0);}to{transform:translateY(18px);}}
