...
(function () {
	...
	const THEMES = {
		...
		monoLight: {
			label: "Mono Light",
			top: "rgba(226, 232, 240, 0.35)",
			bottom: "rgba(248, 250, 252, 0.28)",
			accentBgSoft: "rgba(226, 232, 240, 0.12)",
			accentBg: "rgba(226, 232, 240, 0.18)",
			accentBgHover: "rgba(226, 232, 240, 0.24)",
			accentBadgeBg: "rgba(226, 232, 240, 0.24)",
			accentStrong: "rgba(203, 213, 225, 0.6)",
			accentStrongHover: "rgba(203, 213, 225, 0.7)",
			accentStrongActive: "rgba(203, 213, 225, 0.8)",
			accentBorder: "rgba(226, 232, 240, 0.3)",
			accentBorderStrong: "rgba(226, 232, 240, 0.4)",
			accentText: "rgba(248, 250, 252, 0.98)",
			accentTextSoft: "rgba(226, 232, 240, 0.92)",
			accentRing: "rgba(226, 232, 240, 0.25)",
			accentRingStrong: "rgba(226, 232, 240, 0.4)",
		},
		monoDark: {
			label: "Mono Dark",
			top: "rgba(15, 23, 42, 0.35)",
			bottom: "rgba(2, 6, 23, 0.45)",
			accentBgSoft: "rgba(71, 85, 105, 0.12)",
			accentBg: "rgba(71, 85, 105, 0.18)",
			accentBgHover: "rgba(71, 85, 105, 0.24)",
			accentBadgeBg: "rgba(71, 85, 105, 0.24)",
			accentStrong: "rgba(71, 85, 105, 0.6)",
			accentStrongHover: "rgba(71, 85, 105, 0.7)",
			accentStrongActive: "rgba(71, 85, 105, 0.8)",
			accentBorder: "rgba(71, 85, 105, 0.3)",
			accentBorderStrong: "rgba(71, 85, 105, 0.4)",
			accentText: "rgba(226, 232, 240, 0.98)",
			accentTextSoft: "rgba(148, 163, 184, 0.95)",
			accentRing: "rgba(71, 85, 105, 0.25)",
			accentRingStrong: "rgba(71, 85, 105, 0.4)",
		},
		violet: {
			label: "Violet",
