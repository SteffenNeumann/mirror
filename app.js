...
<head>
  ...
  <style>
    ...
    table{border-collapse:collapse;width:100%;}
		...
		ul.task-list li,ol.task-list li,li.task-list-item{display:flex;gap:.55rem;align-items:flex-start;flex-wrap:nowrap;white-space:nowrap;position:relative;padding-bottom:0.6rem;min-width:0;transition:transform 1.8s ease;will-change:transform;color:var(--accent-text);font-size:1.1rem;font-weight:400;}
		...
		ul.task-list li > .task-closed-at,ol.task-list li > .task-closed-at,li.task-list-item > .task-closed-at{margin-left:0.5rem;white-space:nowrap;flex-shrink:0;}
		.task-closed-at{display:inline;font-size:.75rem;line-height:1.2;color:var(--task-closed-text);opacity:.85;text-decoration:none !important;}
