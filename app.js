...
<body>
	...
	const PW_ICON_EYE = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>';
	...
	function renderPasswordToken(raw) {
		...
		return `<span class="pw-field" data-pw="${escaped}"><span class="pw-mask" aria-hidden="true">${dots}</span><span class="pw-value">${escaped}</span><button type="button" class="pw-toggle" title="Anzeigen" aria-label="Passwort anzeigen">${PW_ICON_EYE}</button><button type="button" class="pw-copy" title="Kopieren" aria-label="Passwort kopieren">${PW_ICON_COPY}</button></span>`;
	}
	...
	function togglePasswordField(field, force) {
		...
		if (toggleBtn) {
			...
			toggleBtn.innerHTML = next ? PW_ICON_EYE_OFF : PW_ICON_EYE;
		}
		return next;
	}
		...
		(function(){
			...
			document.addEventListener('change', function(ev){
				...
				document.addEventListener('click', function(ev){
					...
					var PW_ICON_EYE = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>';
					var PW_ICON_EYE_OFF = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"/><line x1="1" y1="1" x2="23" y2="23"/></svg>';
					...
					function setPasswordRevealed(field, on){
						...
						if (toggleBtn) {
							toggleBtn.innerHTML = on ? PW_ICON_EYE_OFF : PW_ICON_EYE;
